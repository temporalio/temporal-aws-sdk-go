...
func (a *stub) WaitUntilClusterAvailableAsync(ctx workflow.Context, input *redshift.DescribeClustersInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilClusterDeletedAsync(ctx workflow.Context, input *redshift.DescribeClustersInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilClusterRestoredAsync(ctx workflow.Context, input *redshift.DescribeClustersInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilSnapshotAvailableAsync(ctx workflow.Context, input *redshift.DescribeClusterSnapshotsInput) *awsclients.VoidFuture {
