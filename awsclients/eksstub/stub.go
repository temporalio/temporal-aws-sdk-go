...
func (a *stub) WaitUntilClusterActiveAsync(ctx workflow.Context, input *eks.DescribeClusterInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilClusterDeletedAsync(ctx workflow.Context, input *eks.DescribeClusterInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilNodegroupActiveAsync(ctx workflow.Context, input *eks.DescribeNodegroupInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilNodegroupDeletedAsync(ctx workflow.Context, input *eks.DescribeNodegroupInput) *awsclients.VoidFuture {
