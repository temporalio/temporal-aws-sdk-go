...
type Client interface {
	...
	WaitUntilClusterActiveAsync(ctx workflow.Context, input *eks.DescribeClusterInput) *awsclients.VoidFuture

	WaitUntilClusterDeleted(ctx workflow.Context, input *eks.DescribeClusterInput) error
	WaitUntilClusterDeletedAsync(ctx workflow.Context, input *eks.DescribeClusterInput) *awsclients.VoidFuture

	WaitUntilNodegroupActive(ctx workflow.Context, input *eks.DescribeNodegroupInput) error
	WaitUntilNodegroupActiveAsync(ctx workflow.Context, input *eks.DescribeNodegroupInput) *awsclients.VoidFuture

	WaitUntilNodegroupDeleted(ctx workflow.Context, input *eks.DescribeNodegroupInput) error
	WaitUntilNodegroupDeletedAsync(ctx workflow.Context, input *eks.DescribeNodegroupInput) *awsclients.VoidFuture
}
