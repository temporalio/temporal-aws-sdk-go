...
func (a *stub) WaitUntilStreamExistsAsync(ctx workflow.Context, input *kinesis.DescribeStreamInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilStreamNotExistsAsync(ctx workflow.Context, input *kinesis.DescribeStreamInput) *awsclients.VoidFuture {
