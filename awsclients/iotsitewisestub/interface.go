...
type Client interface {
	...
	WaitUntilAssetActiveAsync(ctx workflow.Context, input *iotsitewise.DescribeAssetInput) *awsclients.VoidFuture

	WaitUntilAssetModelActive(ctx workflow.Context, input *iotsitewise.DescribeAssetModelInput) error
	WaitUntilAssetModelActiveAsync(ctx workflow.Context, input *iotsitewise.DescribeAssetModelInput) *awsclients.VoidFuture

	WaitUntilAssetModelNotExists(ctx workflow.Context, input *iotsitewise.DescribeAssetModelInput) error
	WaitUntilAssetModelNotExistsAsync(ctx workflow.Context, input *iotsitewise.DescribeAssetModelInput) *awsclients.VoidFuture

	WaitUntilAssetNotExists(ctx workflow.Context, input *iotsitewise.DescribeAssetInput) error
	WaitUntilAssetNotExistsAsync(ctx workflow.Context, input *iotsitewise.DescribeAssetInput) *awsclients.VoidFuture

	WaitUntilPortalActive(ctx workflow.Context, input *iotsitewise.DescribePortalInput) error
	WaitUntilPortalActiveAsync(ctx workflow.Context, input *iotsitewise.DescribePortalInput) *awsclients.VoidFuture

	WaitUntilPortalNotExists(ctx workflow.Context, input *iotsitewise.DescribePortalInput) error
	WaitUntilPortalNotExistsAsync(ctx workflow.Context, input *iotsitewise.DescribePortalInput) *awsclients.VoidFuture
}
