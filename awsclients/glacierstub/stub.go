...
func (a *stub) WaitUntilVaultExistsAsync(ctx workflow.Context, input *glacier.DescribeVaultInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilVaultNotExistsAsync(ctx workflow.Context, input *glacier.DescribeVaultInput) *awsclients.VoidFuture {
