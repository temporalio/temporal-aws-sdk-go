...
type Client interface {
	...
	WaitUntilVaultExistsAsync(ctx workflow.Context, input *glacier.DescribeVaultInput) *awsclients.VoidFuture

	WaitUntilVaultNotExists(ctx workflow.Context, input *glacier.DescribeVaultInput) error
	WaitUntilVaultNotExistsAsync(ctx workflow.Context, input *glacier.DescribeVaultInput) *awsclients.VoidFuture
}
