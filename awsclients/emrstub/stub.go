...
func (a *stub) WaitUntilClusterRunningAsync(ctx workflow.Context, input *emr.DescribeClusterInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilClusterTerminatedAsync(ctx workflow.Context, input *emr.DescribeClusterInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilStepCompleteAsync(ctx workflow.Context, input *emr.DescribeStepInput) *awsclients.VoidFuture {
