...
func (a *stub) WaitUntilServicesInactiveAsync(ctx workflow.Context, input *ecs.DescribeServicesInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilServicesStableAsync(ctx workflow.Context, input *ecs.DescribeServicesInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilTasksRunningAsync(ctx workflow.Context, input *ecs.DescribeTasksInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilTasksStoppedAsync(ctx workflow.Context, input *ecs.DescribeTasksInput) *awsclients.VoidFuture {
