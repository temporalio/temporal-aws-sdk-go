...
func (a *stub) WaitUntilFunctionActiveAsync(ctx workflow.Context, input *lambda.GetFunctionConfigurationInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilFunctionExistsAsync(ctx workflow.Context, input *lambda.GetFunctionInput) *awsclients.VoidFuture {
...
func (a *stub) WaitUntilFunctionUpdatedAsync(ctx workflow.Context, input *lambda.GetFunctionConfigurationInput) *awsclients.VoidFuture {
