...
type GlueClient interface {
	...
	BatchUpdatePartitionAsync(ctx workflow.Context, input *glue.BatchUpdatePartitionInput) *GlueBatchUpdatePartitionResult
...
type GlueBatchUpdatePartitionResult struct {
	Result workflow.Future
}

func (r *GlueBatchUpdatePartitionResult) Get(ctx workflow.Context) (*glue.BatchUpdatePartitionOutput, error) {
...
func (a *GlueStub) BatchUpdatePartitionAsync(ctx workflow.Context, input *glue.BatchUpdatePartitionInput) *GlueBatchUpdatePartitionResult {
	future := workflow.ExecuteActivity(ctx, "aws.glue.BatchUpdatePartition", input)
	return &GlueBatchUpdatePartitionResult{Result: future}
}
