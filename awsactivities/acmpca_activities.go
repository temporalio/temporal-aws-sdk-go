...
func (a *ACMPCAActivities) WaitUntilAuditReportCreated(input *acmpca.WaitUntilAuditReportCreatedInput) (*acmpca.WaitUntilAuditReportCreatedOutput, error) {
    return a.client.WaitUntilAuditReportCreated(input)
}

func (a *ACMPCAActivities) WaitUntilCertificateAuthorityCSRCreated(input *acmpca.WaitUntilCertificateAuthorityCSRCreatedInput) (*acmpca.WaitUntilCertificateAuthorityCSRCreatedOutput, error) {
    return a.client.WaitUntilCertificateAuthorityCSRCreated(input)
}

func (a *ACMPCAActivities) WaitUntilCertificateIssued(input *acmpca.WaitUntilCertificateIssuedInput) (*acmpca.WaitUntilCertificateIssuedOutput, error) {
