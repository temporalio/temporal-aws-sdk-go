...
func (a *KinesisActivities) DisableEnhancedMonitoring(input *kinesis.DisableEnhancedMonitoringInput) (*kinesis.DisableEnhancedMonitoringOutput, error) {
    return a.client.DisableEnhancedMonitoring(input)
}

func (a *KinesisActivities) EnableEnhancedMonitoring(input *kinesis.EnableEnhancedMonitoringInput) (*kinesis.EnableEnhancedMonitoringOutput, error) {
...
func (a *KinesisActivities) WaitUntilStreamExists(input *kinesis.WaitUntilStreamExistsInput) (*kinesis.WaitUntilStreamExistsOutput, error) {
    return a.client.WaitUntilStreamExists(input)
}

func (a *KinesisActivities) WaitUntilStreamNotExists(input *kinesis.WaitUntilStreamNotExistsInput) (*kinesis.WaitUntilStreamNotExistsOutput, error) {
