...
func (a *OpsWorksActivities) WaitUntilAppExists(input *opsworks.DescribeAppsInput) error {
	return a.client.WaitUntilAppExists(input)
}

func (a *OpsWorksActivities) WaitUntilDeploymentSuccessful(input *opsworks.DescribeDeploymentsInput) error {
	return a.client.WaitUntilDeploymentSuccessful(input)
}

func (a *OpsWorksActivities) WaitUntilInstanceOnline(input *opsworks.DescribeInstancesInput) error {
	return a.client.WaitUntilInstanceOnline(input)
}

func (a *OpsWorksActivities) WaitUntilInstanceRegistered(input *opsworks.DescribeInstancesInput) error {
	return a.client.WaitUntilInstanceRegistered(input)
}

func (a *OpsWorksActivities) WaitUntilInstanceStopped(input *opsworks.DescribeInstancesInput) error {
	return a.client.WaitUntilInstanceStopped(input)
}

func (a *OpsWorksActivities) WaitUntilInstanceTerminated(input *opsworks.DescribeInstancesInput) error {
