...
func (a *RDSActivities) ModifyDBClusterParameterGroup(input *rds.ModifyDBClusterParameterGroupInput) (*rds.ModifyDBClusterParameterGroupOutput, error) {
...
func (a *RDSActivities) ModifyDBParameterGroup(input *rds.ModifyDBParameterGroupInput) (*rds.ModifyDBParameterGroupOutput, error) {
...
func (a *RDSActivities) ResetDBClusterParameterGroup(input *rds.ResetDBClusterParameterGroupInput) (*rds.ResetDBClusterParameterGroupOutput, error) {
    return a.client.ResetDBClusterParameterGroup(input)
}

func (a *RDSActivities) ResetDBParameterGroup(input *rds.ResetDBParameterGroupInput) (*rds.ResetDBParameterGroupOutput, error) {
...
func (a *RDSActivities) WaitUntilDBClusterSnapshotAvailable(input *rds.WaitUntilDBClusterSnapshotAvailableInput) (*rds.WaitUntilDBClusterSnapshotAvailableOutput, error) {
    return a.client.WaitUntilDBClusterSnapshotAvailable(input)
}

func (a *RDSActivities) WaitUntilDBClusterSnapshotDeleted(input *rds.WaitUntilDBClusterSnapshotDeletedInput) (*rds.WaitUntilDBClusterSnapshotDeletedOutput, error) {
    return a.client.WaitUntilDBClusterSnapshotDeleted(input)
}

func (a *RDSActivities) WaitUntilDBInstanceAvailable(input *rds.WaitUntilDBInstanceAvailableInput) (*rds.WaitUntilDBInstanceAvailableOutput, error) {
    return a.client.WaitUntilDBInstanceAvailable(input)
}

func (a *RDSActivities) WaitUntilDBInstanceDeleted(input *rds.WaitUntilDBInstanceDeletedInput) (*rds.WaitUntilDBInstanceDeletedOutput, error) {
    return a.client.WaitUntilDBInstanceDeleted(input)
}

func (a *RDSActivities) WaitUntilDBSnapshotAvailable(input *rds.WaitUntilDBSnapshotAvailableInput) (*rds.WaitUntilDBSnapshotAvailableOutput, error) {
    return a.client.WaitUntilDBSnapshotAvailable(input)
}

func (a *RDSActivities) WaitUntilDBSnapshotDeleted(input *rds.WaitUntilDBSnapshotDeletedInput) (*rds.WaitUntilDBSnapshotDeletedOutput, error) {
