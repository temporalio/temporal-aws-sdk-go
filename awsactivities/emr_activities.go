...
func (a *EMRActivities) WaitUntilClusterRunning(input *emr.WaitUntilClusterRunningInput) (*emr.WaitUntilClusterRunningOutput, error) {
    return a.client.WaitUntilClusterRunning(input)
}

func (a *EMRActivities) WaitUntilClusterTerminated(input *emr.WaitUntilClusterTerminatedInput) (*emr.WaitUntilClusterTerminatedOutput, error) {
    return a.client.WaitUntilClusterTerminated(input)
}

func (a *EMRActivities) WaitUntilStepComplete(input *emr.WaitUntilStepCompleteInput) (*emr.WaitUntilStepCompleteOutput, error) {
