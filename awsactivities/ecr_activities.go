...
func (a *ECRActivities) WaitUntilImageScanComplete(input *ecr.WaitUntilImageScanCompleteInput) (*ecr.WaitUntilImageScanCompleteOutput, error) {
    return a.client.WaitUntilImageScanComplete(input)
}

func (a *ECRActivities) WaitUntilLifecyclePolicyPreviewComplete(input *ecr.WaitUntilLifecyclePolicyPreviewCompleteInput) (*ecr.WaitUntilLifecyclePolicyPreviewCompleteOutput, error) {
