...
func (a *MachineLearningActivities) WaitUntilBatchPredictionAvailable(input *machinelearning.WaitUntilBatchPredictionAvailableInput) (*machinelearning.WaitUntilBatchPredictionAvailableOutput, error) {
    return a.client.WaitUntilBatchPredictionAvailable(input)
}

func (a *MachineLearningActivities) WaitUntilDataSourceAvailable(input *machinelearning.WaitUntilDataSourceAvailableInput) (*machinelearning.WaitUntilDataSourceAvailableOutput, error) {
    return a.client.WaitUntilDataSourceAvailable(input)
}

func (a *MachineLearningActivities) WaitUntilEvaluationAvailable(input *machinelearning.WaitUntilEvaluationAvailableInput) (*machinelearning.WaitUntilEvaluationAvailableOutput, error) {
    return a.client.WaitUntilEvaluationAvailable(input)
}

func (a *MachineLearningActivities) WaitUntilMLModelAvailable(input *machinelearning.WaitUntilMLModelAvailableInput) (*machinelearning.WaitUntilMLModelAvailableOutput, error) {
