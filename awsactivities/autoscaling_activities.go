...
func NewAutoScalingActivities(client autoscalingiface.AutoScalingAPI) *AutoScalingActivities {
...
func (a *AutoScalingActivities) ResumeProcesses(input *autoscaling.ResumeProcessesInput) (*autoscaling.ResumeProcessesOutput, error) {
...
func (a *AutoScalingActivities) SuspendProcesses(input *autoscaling.SuspendProcessesInput) (*autoscaling.SuspendProcessesOutput, error) {
...
func (a *AutoScalingActivities) WaitUntilGroupExists(input *autoscaling.WaitUntilGroupExistsInput) (*autoscaling.WaitUntilGroupExistsOutput, error) {
    return a.client.WaitUntilGroupExists(input)
}

func (a *AutoScalingActivities) WaitUntilGroupInService(input *autoscaling.WaitUntilGroupInServiceInput) (*autoscaling.WaitUntilGroupInServiceOutput, error) {
    return a.client.WaitUntilGroupInService(input)
}

func (a *AutoScalingActivities) WaitUntilGroupNotExists(input *autoscaling.WaitUntilGroupNotExistsInput) (*autoscaling.WaitUntilGroupNotExistsOutput, error) {
