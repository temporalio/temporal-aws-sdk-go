...
func (a *IoTSiteWiseActivities) WaitUntilAssetActive(input *iotsitewise.WaitUntilAssetActiveInput) (*iotsitewise.WaitUntilAssetActiveOutput, error) {
    return a.client.WaitUntilAssetActive(input)
}

func (a *IoTSiteWiseActivities) WaitUntilAssetModelActive(input *iotsitewise.WaitUntilAssetModelActiveInput) (*iotsitewise.WaitUntilAssetModelActiveOutput, error) {
    return a.client.WaitUntilAssetModelActive(input)
}

func (a *IoTSiteWiseActivities) WaitUntilAssetModelNotExists(input *iotsitewise.WaitUntilAssetModelNotExistsInput) (*iotsitewise.WaitUntilAssetModelNotExistsOutput, error) {
    return a.client.WaitUntilAssetModelNotExists(input)
}

func (a *IoTSiteWiseActivities) WaitUntilAssetNotExists(input *iotsitewise.WaitUntilAssetNotExistsInput) (*iotsitewise.WaitUntilAssetNotExistsOutput, error) {
    return a.client.WaitUntilAssetNotExists(input)
}

func (a *IoTSiteWiseActivities) WaitUntilPortalActive(input *iotsitewise.WaitUntilPortalActiveInput) (*iotsitewise.WaitUntilPortalActiveOutput, error) {
    return a.client.WaitUntilPortalActive(input)
}

func (a *IoTSiteWiseActivities) WaitUntilPortalNotExists(input *iotsitewise.WaitUntilPortalNotExistsInput) (*iotsitewise.WaitUntilPortalNotExistsOutput, error) {
