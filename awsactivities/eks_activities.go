...
func (a *EKSActivities) WaitUntilClusterActive(input *eks.WaitUntilClusterActiveInput) (*eks.WaitUntilClusterActiveOutput, error) {
    return a.client.WaitUntilClusterActive(input)
}

func (a *EKSActivities) WaitUntilClusterDeleted(input *eks.WaitUntilClusterDeletedInput) (*eks.WaitUntilClusterDeletedOutput, error) {
    return a.client.WaitUntilClusterDeleted(input)
}

func (a *EKSActivities) WaitUntilNodegroupActive(input *eks.WaitUntilNodegroupActiveInput) (*eks.WaitUntilNodegroupActiveOutput, error) {
    return a.client.WaitUntilNodegroupActive(input)
}

func (a *EKSActivities) WaitUntilNodegroupDeleted(input *eks.WaitUntilNodegroupDeletedInput) (*eks.WaitUntilNodegroupDeletedOutput, error) {
