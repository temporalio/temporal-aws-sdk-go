...
func (a *ElasticTranscoderActivities) CreateJob(input *elastictranscoder.CreateJobInput) (*elastictranscoder.CreateJobOutput, error) {
...
func (a *ElasticTranscoderActivities) WaitUntilJobComplete(input *elastictranscoder.WaitUntilJobCompleteInput) (*elastictranscoder.WaitUntilJobCompleteOutput, error) {
