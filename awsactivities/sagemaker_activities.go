...
func (a *SageMakerActivities) WaitUntilEndpointDeleted(input *sagemaker.WaitUntilEndpointDeletedInput) (*sagemaker.WaitUntilEndpointDeletedOutput, error) {
    return a.client.WaitUntilEndpointDeleted(input)
}

func (a *SageMakerActivities) WaitUntilEndpointInService(input *sagemaker.WaitUntilEndpointInServiceInput) (*sagemaker.WaitUntilEndpointInServiceOutput, error) {
    return a.client.WaitUntilEndpointInService(input)
}

func (a *SageMakerActivities) WaitUntilNotebookInstanceDeleted(input *sagemaker.WaitUntilNotebookInstanceDeletedInput) (*sagemaker.WaitUntilNotebookInstanceDeletedOutput, error) {
    return a.client.WaitUntilNotebookInstanceDeleted(input)
}

func (a *SageMakerActivities) WaitUntilNotebookInstanceInService(input *sagemaker.WaitUntilNotebookInstanceInServiceInput) (*sagemaker.WaitUntilNotebookInstanceInServiceOutput, error) {
    return a.client.WaitUntilNotebookInstanceInService(input)
}

func (a *SageMakerActivities) WaitUntilNotebookInstanceStopped(input *sagemaker.WaitUntilNotebookInstanceStoppedInput) (*sagemaker.WaitUntilNotebookInstanceStoppedOutput, error) {
    return a.client.WaitUntilNotebookInstanceStopped(input)
}

func (a *SageMakerActivities) WaitUntilProcessingJobCompletedOrStopped(input *sagemaker.WaitUntilProcessingJobCompletedOrStoppedInput) (*sagemaker.WaitUntilProcessingJobCompletedOrStoppedOutput, error) {
    return a.client.WaitUntilProcessingJobCompletedOrStopped(input)
}

func (a *SageMakerActivities) WaitUntilTrainingJobCompletedOrStopped(input *sagemaker.WaitUntilTrainingJobCompletedOrStoppedInput) (*sagemaker.WaitUntilTrainingJobCompletedOrStoppedOutput, error) {
    return a.client.WaitUntilTrainingJobCompletedOrStopped(input)
}

func (a *SageMakerActivities) WaitUntilTransformJobCompletedOrStopped(input *sagemaker.WaitUntilTransformJobCompletedOrStoppedInput) (*sagemaker.WaitUntilTransformJobCompletedOrStoppedOutput, error) {
