...
func NewSageMakerActivities(sess *session.Session, config ...*aws.Config) *SageMakerActivities {
	client := sagemaker.New(sess, config...)
	return &SageMakerActivities{client: client}
}

func NewSageMakerActivitiesWithSessionFactory(sessionFactory SessionFactory) *SageMakerActivities {
	return &SageMakerActivities{sessionFactory: sessionFactory}
}

func (a *SageMakerActivities) getClient(ctx context.Context) (sagemakeriface.SageMakerAPI, error) {
