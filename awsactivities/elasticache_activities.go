...
func (a *ElastiCacheActivities) AddTagsToResource(input *elasticache.AddTagsToResourceInput) (*elasticache.AddTagsToResourceOutput, error) {
...
func (a *ElastiCacheActivities) ListTagsForResource(input *elasticache.ListTagsForResourceInput) (*elasticache.ListTagsForResourceOutput, error) {
...
func (a *ElastiCacheActivities) ModifyCacheParameterGroup(input *elasticache.ModifyCacheParameterGroupInput) (*elasticache.ModifyCacheParameterGroupOutput, error) {
...
func (a *ElastiCacheActivities) RemoveTagsFromResource(input *elasticache.RemoveTagsFromResourceInput) (*elasticache.RemoveTagsFromResourceOutput, error) {
    return a.client.RemoveTagsFromResource(input)
}

func (a *ElastiCacheActivities) ResetCacheParameterGroup(input *elasticache.ResetCacheParameterGroupInput) (*elasticache.ResetCacheParameterGroupOutput, error) {
...
func (a *ElastiCacheActivities) WaitUntilCacheClusterAvailable(input *elasticache.WaitUntilCacheClusterAvailableInput) (*elasticache.WaitUntilCacheClusterAvailableOutput, error) {
    return a.client.WaitUntilCacheClusterAvailable(input)
}

func (a *ElastiCacheActivities) WaitUntilCacheClusterDeleted(input *elasticache.WaitUntilCacheClusterDeletedInput) (*elasticache.WaitUntilCacheClusterDeletedOutput, error) {
    return a.client.WaitUntilCacheClusterDeleted(input)
}

func (a *ElastiCacheActivities) WaitUntilReplicationGroupAvailable(input *elasticache.WaitUntilReplicationGroupAvailableInput) (*elasticache.WaitUntilReplicationGroupAvailableOutput, error) {
    return a.client.WaitUntilReplicationGroupAvailable(input)
}

func (a *ElastiCacheActivities) WaitUntilReplicationGroupDeleted(input *elasticache.WaitUntilReplicationGroupDeletedInput) (*elasticache.WaitUntilReplicationGroupDeletedOutput, error) {
