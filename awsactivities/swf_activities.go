...
func (a *SWFActivities) CountClosedWorkflowExecutions(input *swf.CountClosedWorkflowExecutionsInput) (*swf.CountClosedWorkflowExecutionsOutput, error) {
    return a.client.CountClosedWorkflowExecutions(input)
}

func (a *SWFActivities) CountOpenWorkflowExecutions(input *swf.CountOpenWorkflowExecutionsInput) (*swf.CountOpenWorkflowExecutionsOutput, error) {
    return a.client.CountOpenWorkflowExecutions(input)
}

func (a *SWFActivities) CountPendingActivityTasks(input *swf.CountPendingActivityTasksInput) (*swf.CountPendingActivityTasksOutput, error) {
    return a.client.CountPendingActivityTasks(input)
}

func (a *SWFActivities) CountPendingDecisionTasks(input *swf.CountPendingDecisionTasksInput) (*swf.CountPendingDecisionTasksOutput, error) {
...
func (a *SWFActivities) ListClosedWorkflowExecutions(input *swf.ListClosedWorkflowExecutionsInput) (*swf.ListClosedWorkflowExecutionsOutput, error) {
...
func (a *SWFActivities) ListOpenWorkflowExecutions(input *swf.ListOpenWorkflowExecutionsInput) (*swf.ListOpenWorkflowExecutionsOutput, error) {
