...
func NewOpsWorksCMActivities(client opsworkscmiface.OpsWorksCMAPI) *OpsWorksCMActivities {
...
func (a *OpsWorksCMActivities) WaitUntilNodeAssociated(input *opsworkscm.WaitUntilNodeAssociatedInput) (*opsworkscm.WaitUntilNodeAssociatedOutput, error) {
