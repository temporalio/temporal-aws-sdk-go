...
func (a *LambdaActivities) CreateAlias(input *lambda.CreateAliasInput) (*lambda.CreateAliasOutput, error) {
    return a.client.CreateAlias(input)
}

func (a *LambdaActivities) CreateEventSourceMapping(input *lambda.CreateEventSourceMappingInput) (*lambda.CreateEventSourceMappingOutput, error) {
    return a.client.CreateEventSourceMapping(input)
}

func (a *LambdaActivities) CreateFunction(input *lambda.CreateFunctionInput) (*lambda.CreateFunctionOutput, error) {
...
func (a *LambdaActivities) DeleteEventSourceMapping(input *lambda.DeleteEventSourceMappingInput) (*lambda.DeleteEventSourceMappingOutput, error) {
...
func (a *LambdaActivities) GetAlias(input *lambda.GetAliasInput) (*lambda.GetAliasOutput, error) {
    return a.client.GetAlias(input)
}

func (a *LambdaActivities) GetEventSourceMapping(input *lambda.GetEventSourceMappingInput) (*lambda.GetEventSourceMappingOutput, error) {
...
func (a *LambdaActivities) GetFunctionConfiguration(input *lambda.GetFunctionConfigurationInput) (*lambda.GetFunctionConfigurationOutput, error) {
...
func (a *LambdaActivities) InvokeAsync(input *lambda.InvokeAsyncInput) (*lambda.InvokeAsyncOutput, error) {
    return a.client.InvokeAsync(input)
}
...
func (a *LambdaActivities) PublishVersion(input *lambda.PublishVersionInput) (*lambda.PublishVersionOutput, error) {
...
func (a *LambdaActivities) UpdateAlias(input *lambda.UpdateAliasInput) (*lambda.UpdateAliasOutput, error) {
    return a.client.UpdateAlias(input)
}

func (a *LambdaActivities) UpdateEventSourceMapping(input *lambda.UpdateEventSourceMappingInput) (*lambda.UpdateEventSourceMappingOutput, error) {
    return a.client.UpdateEventSourceMapping(input)
}

func (a *LambdaActivities) UpdateFunctionCode(input *lambda.UpdateFunctionCodeInput) (*lambda.UpdateFunctionCodeOutput, error) {
    return a.client.UpdateFunctionCode(input)
}

func (a *LambdaActivities) UpdateFunctionConfiguration(input *lambda.UpdateFunctionConfigurationInput) (*lambda.UpdateFunctionConfigurationOutput, error) {
...
func (a *LambdaActivities) WaitUntilFunctionActive(input *lambda.WaitUntilFunctionActiveInput) (*lambda.WaitUntilFunctionActiveOutput, error) {
    return a.client.WaitUntilFunctionActive(input)
}

func (a *LambdaActivities) WaitUntilFunctionExists(input *lambda.WaitUntilFunctionExistsInput) (*lambda.WaitUntilFunctionExistsOutput, error) {
    return a.client.WaitUntilFunctionExists(input)
}

func (a *LambdaActivities) WaitUntilFunctionUpdated(input *lambda.WaitUntilFunctionUpdatedInput) (*lambda.WaitUntilFunctionUpdatedOutput, error) {
