...
func (a *CognitoIdentityActivities) CreateIdentityPool(input *cognitoidentity.CreateIdentityPoolInput) (*cognitoidentity.IdentityPool, error) {
...
func (a *CognitoIdentityActivities) DescribeIdentity(input *cognitoidentity.DescribeIdentityInput) (*cognitoidentity.IdentityDescription, error) {
    return a.client.DescribeIdentity(input)
}

func (a *CognitoIdentityActivities) DescribeIdentityPool(input *cognitoidentity.DescribeIdentityPoolInput) (*cognitoidentity.IdentityPool, error) {
...
func (a *CognitoIdentityActivities) UpdateIdentityPool(input *cognitoidentity.IdentityPool) (*cognitoidentity.IdentityPool, error) {
