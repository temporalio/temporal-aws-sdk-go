...
func (a *RekognitionActivities) WaitUntilProjectVersionRunning(input *rekognition.WaitUntilProjectVersionRunningInput) (*rekognition.WaitUntilProjectVersionRunningOutput, error) {
    return a.client.WaitUntilProjectVersionRunning(input)
}

func (a *RekognitionActivities) WaitUntilProjectVersionTrainingCompleted(input *rekognition.WaitUntilProjectVersionTrainingCompletedInput) (*rekognition.WaitUntilProjectVersionTrainingCompletedOutput, error) {
