...
type LambdaClient interface {
    ...
    InvokeAsync(ctx workflow.Context, input *lambda.InvokeAsyncInput) (*lambda.InvokeAsyncOutput, error)
    InvokeAsyncAsync(ctx workflow.Context, input *lambda.InvokeAsyncInput) *LambdaInvokeAsyncResult
...
type LambdaInvokeAsyncResult struct {
	Result workflow.Future
}

func (r *LambdaInvokeAsyncResult) Get(ctx workflow.Context) (*lambda.InvokeAsyncOutput, error) {
    var output lambda.InvokeAsyncOutput
    err := r.Result.Get(ctx, &output)
    return &output, err
}
...
func (a *LambdaStub) InvokeAsync(ctx workflow.Context, input *lambda.InvokeAsyncInput) (*lambda.InvokeAsyncOutput, error) {
    var output lambda.InvokeAsyncOutput
    err := workflow.ExecuteActivity(ctx, a.activities.InvokeAsync, input).Get(ctx, &output)
    return &output, err
}
