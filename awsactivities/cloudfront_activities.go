...
func (a *CloudFrontActivities) WaitUntilDistributionDeployed(input *cloudfront.WaitUntilDistributionDeployedInput) (*cloudfront.WaitUntilDistributionDeployedOutput, error) {
    return a.client.WaitUntilDistributionDeployed(input)
}

func (a *CloudFrontActivities) WaitUntilInvalidationCompleted(input *cloudfront.WaitUntilInvalidationCompletedInput) (*cloudfront.WaitUntilInvalidationCompletedOutput, error) {
    return a.client.WaitUntilInvalidationCompleted(input)
}

func (a *CloudFrontActivities) WaitUntilStreamingDistributionDeployed(input *cloudfront.WaitUntilStreamingDistributionDeployedInput) (*cloudfront.WaitUntilStreamingDistributionDeployedOutput, error) {
