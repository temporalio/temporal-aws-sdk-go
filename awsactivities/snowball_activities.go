...
func NewSnowballActivities(sess *session.Session, config ...*aws.Config) *SnowballActivities {
	client := snowball.New(sess, config...)
	return &SnowballActivities{client: client}
}

func NewSnowballActivitiesWithSessionFactory(sessionFactory SessionFactory) *SnowballActivities {
	return &SnowballActivities{sessionFactory: sessionFactory}
}

func (a *SnowballActivities) getClient(ctx context.Context) (snowballiface.SnowballAPI, error) {
