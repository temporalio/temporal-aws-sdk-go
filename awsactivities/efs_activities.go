...
func NewEFSActivities(sess *session.Session, config ...*aws.Config) *EFSActivities {
	client := efs.New(sess, config...)
	return &EFSActivities{client: client}
}

func NewEFSActivitiesWithSessionFactory(sessionFactory SessionFactory) *EFSActivities {
	return &EFSActivities{sessionFactory: sessionFactory}
}

func (a *EFSActivities) getClient(ctx context.Context) (efsiface.EFSAPI, error) {
