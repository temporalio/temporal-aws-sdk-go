...
func (a *EFSActivities) CreateFileSystem(input *efs.CreateFileSystemInput) (*efs.CreateFileSystemOutput, error) {
    return a.client.CreateFileSystem(input)
}

func (a *EFSActivities) CreateMountTarget(input *efs.CreateMountTargetInput) (*efs.CreateMountTargetOutput, error) {
