...
func (a *S3Activities) GetBucketNotification(input *s3.GetBucketNotificationInput) (*s3.GetBucketNotificationOutput, error) {
    return a.client.GetBucketNotification(input)
}

func (a *S3Activities) GetBucketNotificationConfiguration(input *s3.GetBucketNotificationConfigurationInput) (*s3.GetBucketNotificationConfigurationOutput, error) {
...
func (a *S3Activities) WaitUntilBucketExists(input *s3.WaitUntilBucketExistsInput) (*s3.WaitUntilBucketExistsOutput, error) {
    return a.client.WaitUntilBucketExists(input)
}

func (a *S3Activities) WaitUntilBucketNotExists(input *s3.WaitUntilBucketNotExistsInput) (*s3.WaitUntilBucketNotExistsOutput, error) {
    return a.client.WaitUntilBucketNotExists(input)
}

func (a *S3Activities) WaitUntilObjectExists(input *s3.WaitUntilObjectExistsInput) (*s3.WaitUntilObjectExistsOutput, error) {
    return a.client.WaitUntilObjectExists(input)
}

func (a *S3Activities) WaitUntilObjectNotExists(input *s3.WaitUntilObjectNotExistsInput) (*s3.WaitUntilObjectNotExistsOutput, error) {
