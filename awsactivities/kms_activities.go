...
func (a *KMSActivities) ListGrants(input *kms.ListGrantsInput) (*kms.ListGrantsOutput, error) {
...
func (a *KMSActivities) ListRetirableGrants(input *kms.ListRetirableGrantsInput) (*kms.ListRetirableGrantsOutput, error) {
