...
func (a *GlacierActivities) CompleteMultipartUpload(input *glacier.CompleteMultipartUploadInput) (*glacier.CompleteMultipartUploadOutput, error) {
...
func (a *GlacierActivities) DescribeJob(input *glacier.DescribeJobInput) (*glacier.DescribeJobOutput, error) {
...
func (a *GlacierActivities) UploadArchive(input *glacier.UploadArchiveInput) (*glacier.UploadArchiveOutput, error) {
...
func (a *GlacierActivities) WaitUntilVaultExists(input *glacier.WaitUntilVaultExistsInput) (*glacier.WaitUntilVaultExistsOutput, error) {
    return a.client.WaitUntilVaultExists(input)
}

func (a *GlacierActivities) WaitUntilVaultNotExists(input *glacier.WaitUntilVaultNotExistsInput) (*glacier.WaitUntilVaultNotExistsOutput, error) {
