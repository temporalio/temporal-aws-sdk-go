...
func (a *DocDBActivities) WaitUntilDBInstanceAvailable(input *docdb.WaitUntilDBInstanceAvailableInput) (*docdb.WaitUntilDBInstanceAvailableOutput, error) {
    return a.client.WaitUntilDBInstanceAvailable(input)
}

func (a *DocDBActivities) WaitUntilDBInstanceDeleted(input *docdb.WaitUntilDBInstanceDeletedInput) (*docdb.WaitUntilDBInstanceDeletedOutput, error) {
