...
func (a *MediaLiveActivities) WaitUntilChannelCreated(input *medialive.WaitUntilChannelCreatedInput) (*medialive.WaitUntilChannelCreatedOutput, error) {
    return a.client.WaitUntilChannelCreated(input)
}

func (a *MediaLiveActivities) WaitUntilChannelDeleted(input *medialive.WaitUntilChannelDeletedInput) (*medialive.WaitUntilChannelDeletedOutput, error) {
    return a.client.WaitUntilChannelDeleted(input)
}

func (a *MediaLiveActivities) WaitUntilChannelRunning(input *medialive.WaitUntilChannelRunningInput) (*medialive.WaitUntilChannelRunningOutput, error) {
    return a.client.WaitUntilChannelRunning(input)
}

func (a *MediaLiveActivities) WaitUntilChannelStopped(input *medialive.WaitUntilChannelStoppedInput) (*medialive.WaitUntilChannelStoppedOutput, error) {
    return a.client.WaitUntilChannelStopped(input)
}

func (a *MediaLiveActivities) WaitUntilInputAttached(input *medialive.WaitUntilInputAttachedInput) (*medialive.WaitUntilInputAttachedOutput, error) {
    return a.client.WaitUntilInputAttached(input)
}

func (a *MediaLiveActivities) WaitUntilInputDeleted(input *medialive.WaitUntilInputDeletedInput) (*medialive.WaitUntilInputDeletedOutput, error) {
    return a.client.WaitUntilInputDeleted(input)
}

func (a *MediaLiveActivities) WaitUntilInputDetached(input *medialive.WaitUntilInputDetachedInput) (*medialive.WaitUntilInputDetachedOutput, error) {
    return a.client.WaitUntilInputDetached(input)
}

func (a *MediaLiveActivities) WaitUntilMultiplexCreated(input *medialive.WaitUntilMultiplexCreatedInput) (*medialive.WaitUntilMultiplexCreatedOutput, error) {
    return a.client.WaitUntilMultiplexCreated(input)
}

func (a *MediaLiveActivities) WaitUntilMultiplexDeleted(input *medialive.WaitUntilMultiplexDeletedInput) (*medialive.WaitUntilMultiplexDeletedOutput, error) {
    return a.client.WaitUntilMultiplexDeleted(input)
}

func (a *MediaLiveActivities) WaitUntilMultiplexRunning(input *medialive.WaitUntilMultiplexRunningInput) (*medialive.WaitUntilMultiplexRunningOutput, error) {
    return a.client.WaitUntilMultiplexRunning(input)
}

func (a *MediaLiveActivities) WaitUntilMultiplexStopped(input *medialive.WaitUntilMultiplexStoppedInput) (*medialive.WaitUntilMultiplexStoppedOutput, error) {
