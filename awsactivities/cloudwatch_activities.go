...
func (a *CloudWatchActivities) WaitUntilAlarmExists(input *cloudwatch.WaitUntilAlarmExistsInput) (*cloudwatch.WaitUntilAlarmExistsOutput, error) {
    return a.client.WaitUntilAlarmExists(input)
}

func (a *CloudWatchActivities) WaitUntilCompositeAlarmExists(input *cloudwatch.WaitUntilCompositeAlarmExistsInput) (*cloudwatch.WaitUntilCompositeAlarmExistsOutput, error) {
