...
func (a *DynamoDBActivities) WaitUntilTableExists(input *dynamodb.WaitUntilTableExistsInput) (*dynamodb.WaitUntilTableExistsOutput, error) {
    return a.client.WaitUntilTableExists(input)
}

func (a *DynamoDBActivities) WaitUntilTableNotExists(input *dynamodb.WaitUntilTableNotExistsInput) (*dynamodb.WaitUntilTableNotExistsOutput, error) {
