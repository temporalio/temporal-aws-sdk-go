...
func (a *DirectConnectActivities) AllocateConnectionOnInterconnect(input *directconnect.AllocateConnectionOnInterconnectInput) (*directconnect.AllocateConnectionOnInterconnectOutput, error) {
    return a.client.AllocateConnectionOnInterconnect(input)
}

func (a *DirectConnectActivities) AllocateHostedConnection(input *directconnect.AllocateHostedConnectionInput) (*directconnect.AllocateHostedConnectionOutput, error) {
    return a.client.AllocateHostedConnection(input)
}

func (a *DirectConnectActivities) AllocatePrivateVirtualInterface(input *directconnect.AllocatePrivateVirtualInterfaceInput) (*directconnect.AllocatePrivateVirtualInterfaceOutput, error) {
    return a.client.AllocatePrivateVirtualInterface(input)
}

func (a *DirectConnectActivities) AllocatePublicVirtualInterface(input *directconnect.AllocatePublicVirtualInterfaceInput) (*directconnect.AllocatePublicVirtualInterfaceOutput, error) {
...
func (a *DirectConnectActivities) AssociateConnectionWithLag(input *directconnect.AssociateConnectionWithLagInput) (*directconnect.AssociateConnectionWithLagOutput, error) {
    return a.client.AssociateConnectionWithLag(input)
}

func (a *DirectConnectActivities) AssociateHostedConnection(input *directconnect.AssociateHostedConnectionInput) (*directconnect.AssociateHostedConnectionOutput, error) {
    return a.client.AssociateHostedConnection(input)
}

func (a *DirectConnectActivities) AssociateVirtualInterface(input *directconnect.AssociateVirtualInterfaceInput) (*directconnect.AssociateVirtualInterfaceOutput, error) {
...
func (a *DirectConnectActivities) CreateConnection(input *directconnect.CreateConnectionInput) (*directconnect.CreateConnectionOutput, error) {
...
func (a *DirectConnectActivities) CreateInterconnect(input *directconnect.CreateInterconnectInput) (*directconnect.CreateInterconnectOutput, error) {
    return a.client.CreateInterconnect(input)
}

func (a *DirectConnectActivities) CreateLag(input *directconnect.CreateLagInput) (*directconnect.CreateLagOutput, error) {
    return a.client.CreateLag(input)
}

func (a *DirectConnectActivities) CreatePrivateVirtualInterface(input *directconnect.CreatePrivateVirtualInterfaceInput) (*directconnect.CreatePrivateVirtualInterfaceOutput, error) {
    return a.client.CreatePrivateVirtualInterface(input)
}

func (a *DirectConnectActivities) CreatePublicVirtualInterface(input *directconnect.CreatePublicVirtualInterfaceInput) (*directconnect.CreatePublicVirtualInterfaceOutput, error) {
...
func (a *DirectConnectActivities) DeleteConnection(input *directconnect.DeleteConnectionInput) (*directconnect.DeleteConnectionOutput, error) {
...
func (a *DirectConnectActivities) DeleteLag(input *directconnect.DeleteLagInput) (*directconnect.DeleteLagOutput, error) {
...
func (a *DirectConnectActivities) DescribeConnections(input *directconnect.DescribeConnectionsInput) (*directconnect.DescribeConnectionsOutput, error) {
    return a.client.DescribeConnections(input)
}

func (a *DirectConnectActivities) DescribeConnectionsOnInterconnect(input *directconnect.DescribeConnectionsOnInterconnectInput) (*directconnect.DescribeConnectionsOnInterconnectOutput, error) {
...
func (a *DirectConnectActivities) DescribeHostedConnections(input *directconnect.DescribeHostedConnectionsInput) (*directconnect.DescribeHostedConnectionsOutput, error) {
...
func (a *DirectConnectActivities) DescribeLoa(input *directconnect.DescribeLoaInput) (*directconnect.DescribeLoaOutput, error) {
...
func (a *DirectConnectActivities) DisassociateConnectionFromLag(input *directconnect.DisassociateConnectionFromLagInput) (*directconnect.DisassociateConnectionFromLagOutput, error) {
...
func (a *DirectConnectActivities) UpdateLag(input *directconnect.UpdateLagInput) (*directconnect.UpdateLagOutput, error) {
