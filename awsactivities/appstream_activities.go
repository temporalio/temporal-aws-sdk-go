...
func (a *AppStreamActivities) WaitUntilFleetStarted(input *appstream.WaitUntilFleetStartedInput) (*appstream.WaitUntilFleetStartedOutput, error) {
    return a.client.WaitUntilFleetStarted(input)
}

func (a *AppStreamActivities) WaitUntilFleetStopped(input *appstream.WaitUntilFleetStoppedInput) (*appstream.WaitUntilFleetStoppedOutput, error) {
