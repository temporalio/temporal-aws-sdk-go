...
func (a *ELBActivities) WaitUntilAnyInstanceInService(input *elb.WaitUntilAnyInstanceInServiceInput) (*elb.WaitUntilAnyInstanceInServiceOutput, error) {
    return a.client.WaitUntilAnyInstanceInService(input)
}

func (a *ELBActivities) WaitUntilInstanceDeregistered(input *elb.WaitUntilInstanceDeregisteredInput) (*elb.WaitUntilInstanceDeregisteredOutput, error) {
    return a.client.WaitUntilInstanceDeregistered(input)
}

func (a *ELBActivities) WaitUntilInstanceInService(input *elb.WaitUntilInstanceInServiceInput) (*elb.WaitUntilInstanceInServiceOutput, error) {
