...
func (a *ELBV2Activities) WaitUntilLoadBalancerAvailable(input *elbv2.WaitUntilLoadBalancerAvailableInput) (*elbv2.WaitUntilLoadBalancerAvailableOutput, error) {
    return a.client.WaitUntilLoadBalancerAvailable(input)
}

func (a *ELBV2Activities) WaitUntilLoadBalancerExists(input *elbv2.WaitUntilLoadBalancerExistsInput) (*elbv2.WaitUntilLoadBalancerExistsOutput, error) {
    return a.client.WaitUntilLoadBalancerExists(input)
}

func (a *ELBV2Activities) WaitUntilLoadBalancersDeleted(input *elbv2.WaitUntilLoadBalancersDeletedInput) (*elbv2.WaitUntilLoadBalancersDeletedOutput, error) {
    return a.client.WaitUntilLoadBalancersDeleted(input)
}

func (a *ELBV2Activities) WaitUntilTargetDeregistered(input *elbv2.WaitUntilTargetDeregisteredInput) (*elbv2.WaitUntilTargetDeregisteredOutput, error) {
    return a.client.WaitUntilTargetDeregistered(input)
}

func (a *ELBV2Activities) WaitUntilTargetInService(input *elbv2.WaitUntilTargetInServiceInput) (*elbv2.WaitUntilTargetInServiceOutput, error) {
