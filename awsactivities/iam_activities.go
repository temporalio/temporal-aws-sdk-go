...
func (a *IAMActivities) GetContextKeysForCustomPolicy(input *iam.GetContextKeysForCustomPolicyInput) (*iam.GetContextKeysForCustomPolicyOutput, error) {
    return a.client.GetContextKeysForCustomPolicy(input)
}

func (a *IAMActivities) GetContextKeysForPrincipalPolicy(input *iam.GetContextKeysForPrincipalPolicyInput) (*iam.GetContextKeysForPrincipalPolicyOutput, error) {
...
func (a *IAMActivities) SimulateCustomPolicy(input *iam.SimulateCustomPolicyInput) (*iam.SimulateCustomPolicyOutput, error) {
    return a.client.SimulateCustomPolicy(input)
}

func (a *IAMActivities) SimulatePrincipalPolicy(input *iam.SimulatePrincipalPolicyInput) (*iam.SimulatePrincipalPolicyOutput, error) {
...
func (a *IAMActivities) WaitUntilInstanceProfileExists(input *iam.WaitUntilInstanceProfileExistsInput) (*iam.WaitUntilInstanceProfileExistsOutput, error) {
    return a.client.WaitUntilInstanceProfileExists(input)
}

func (a *IAMActivities) WaitUntilPolicyExists(input *iam.WaitUntilPolicyExistsInput) (*iam.WaitUntilPolicyExistsOutput, error) {
    return a.client.WaitUntilPolicyExists(input)
}

func (a *IAMActivities) WaitUntilRoleExists(input *iam.WaitUntilRoleExistsInput) (*iam.WaitUntilRoleExistsOutput, error) {
    return a.client.WaitUntilRoleExists(input)
}

func (a *IAMActivities) WaitUntilUserExists(input *iam.WaitUntilUserExistsInput) (*iam.WaitUntilUserExistsOutput, error) {
