...
func (a *ECSActivities) WaitUntilServicesInactive(input *ecs.WaitUntilServicesInactiveInput) (*ecs.WaitUntilServicesInactiveOutput, error) {
    return a.client.WaitUntilServicesInactive(input)
}

func (a *ECSActivities) WaitUntilServicesStable(input *ecs.WaitUntilServicesStableInput) (*ecs.WaitUntilServicesStableOutput, error) {
    return a.client.WaitUntilServicesStable(input)
}

func (a *ECSActivities) WaitUntilTasksRunning(input *ecs.WaitUntilTasksRunningInput) (*ecs.WaitUntilTasksRunningOutput, error) {
    return a.client.WaitUntilTasksRunning(input)
}

func (a *ECSActivities) WaitUntilTasksStopped(input *ecs.WaitUntilTasksStoppedInput) (*ecs.WaitUntilTasksStoppedOutput, error) {
